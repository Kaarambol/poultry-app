...
// Replace this URL with your own poultry farm photo
// Tip: find a free photo at unsplash.com/s/photos/poultry-farm, right-click → Copy image address
    ...
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div className="auth-form-panel" style={{
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <h2 style={{ fontSize: "1.75rem", fontWeight: 800, margin: 0, color: "#1a2e1a" }}>Sign in</h2>
        </div>
        ...
        <p style={{ marginTop: 28, textAlign: "center", fontSize: "0.875rem", color: "#555" }}>
          ...
          <Link href="/register" style={{ color: "#2d6e2d", fontWeight: 600, textDecoration: "none" }}>
            Create one free
          </Link>
        </p>
